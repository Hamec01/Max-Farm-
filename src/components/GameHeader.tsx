...
export const GameHeader: React.FC<GameHeaderProps> = ({
  ...
  return (
    <div className="absolute top-2 left-4 right-4 z-30 flex flex-col md:flex-row items-center justify-between gap-3 w-auto pointer-events-none select-none" id="game-header">
      ...
      <div className="flex flex-col items-center md:items-start text-center md:text-left drop-shadow-[0_2px_4px_rgba(0,0,0,0.6)] pointer-events-auto shrink-0">
        <h1 className="text-xl sm:text-2xl md:text-3xl font-black text-white tracking-tight uppercase italic leading-none animate-pulse" id="game-title">
          Ферма Макса
        </h1>
        <p className="text-[9px] text-[#FEF3C7] font-black mt-1 tracking-wide uppercase leading-none">Добрая ферма для любимого сына</p>
      </div>

      {/* COMPACT LOCATION TABS INTEGRATED DIRECTLY "BETWEEN" TITLE AND INDICATORS */}
      <div className="flex flex-wrap items-center justify-center gap-1 bg-[#451A03]/50 backdrop-blur-xs p-1 px-1.5 rounded-full border border-amber-900/20 pointer-events-auto shrink-0 shadow-inner max-w-full lg:max-w-[45%]" id="header-map-tabs">
        {Object.keys(LOCATIONS).map((locId) => {
          ...
          return (
            <button
              ...
              className={`flex items-center gap-1 p-1 px-2.5 rounded-full text-[9.5px] font-black whitespace-nowrap transition-all duration-150 cursor-pointer border ${
                isActive
      ...
      <div className="flex flex-wrap items-center justify-center md:justify-end gap-2 pointer-events-auto">
        {/* Day / Sunset Widget */}
        <div className="bg-amber-50/95 backdrop-blur-xs border-2 border-[#3B82F6] rounded-full px-2.5 py-0.5 flex items-center gap-1.5 shadow-md select-none transition-all hover:scale-105" id="day-hud-badge">
        ...
        <div className="bg-amber-50/95 backdrop-blur-xs border-2 border-[#D97706] rounded-full px-2.5 py-0.5 flex items-center gap-1.5 shadow-md select-none" id="level-badge">
        ...
        <div className="flex items-center gap-1 text-xs text-[#92400E] w-24 sm:w-28 bg-amber-50/95 backdrop-blur-xs border-2 border-[#D97706] rounded-full px-2 py-0.5 shadow-md" id="exp-container">
        ...
        <div className="bg-amber-50/95 backdrop-blur-xs border-2 border-[#D97706] rounded-full px-2.5 py-0.5 flex items-center gap-1.5 shadow-lg select-none transition-transform hover:scale-105" id="hud-coins">
          <span className="text-base">💰</span>
          <div className="flex flex-col text-left">
        ...
        <div className="flex gap-1" id="hud-buttons">
          <button
            ...
            className="w-7 h-7 bg-white rounded-lg border-2 border-[#3B82F6] hover:bg-blue-50 text-[#3B82F6] flex items-center justify-center shadow-md hover:scale-105 active:scale-90 transition-all text-xs cursor-pointer"
          ...
          <button
            ...
            className="w-7 h-7 bg-white rounded-lg border-2 border-[#F43F5E] hover:bg-rose-50 text-[#F43F5E] flex items-center justify-center shadow-md hover:scale-105 active:scale-90 transition-all text-xs cursor-pointer"
